<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo e(route('profile.index')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo e(route('login.faq')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo e(route('login.login')); ?>">
        ...
        <li class="nav-item">
            ...
            <ul id="error-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="<?php echo e(route('error.500')); ?>">
...
<?php /**PATH D:\epc\xampp\htdocs\AdminMotorcycle\resources\views/layout/sidebar.blade.php ENDPATH**/ ?>