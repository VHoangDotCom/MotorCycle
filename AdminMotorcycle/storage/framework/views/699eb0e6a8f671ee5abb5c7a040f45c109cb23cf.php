    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Frequently Asked Questions & Service Rules</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\epc\xampp\htdocs\AdminMotorcycle\resources\views/login/faq.blade.php ENDPATH**/ ?>