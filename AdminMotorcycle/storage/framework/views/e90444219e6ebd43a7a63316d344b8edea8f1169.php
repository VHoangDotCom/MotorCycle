...
<main>
    <div class="container">
        ...
        <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
            ...
            <h2>Something is broken. Please let us know what you were doing when this error occurred. We will fix it as soon as possible. Sorry for any inconvenience caused.</h2>
            <a class="btn" href="<?php echo e(route('home')); ?>">Back to home</a>
            <img src="<?php echo e(asset('niceadmin/assets/img/not-found.svg')); ?>" class="img-fluid py-5" alt="Page Not Found">
            <div class="credits">
                <!-- All the links in the footer should remain intact. -->
                <!-- You can delete the links only if you purchased the pro version. -->
                <!-- Licensing information: https://bootstrapmade.com/license/ -->
                <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/nice-admin-bootstrap-admin-html-template/ -->
                Designed by <a href="https://www.facebook.com/tung09733">Thanh Tung va nhung nguoi ban</a>
            </div>
        </section>
...
<?php /**PATH D:\epc\xampp\htdocs\AdminMotorcycle\resources\views/errors/405.blade.php ENDPATH**/ ?>