            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <!-- Multi Columns Form -->
                            <form class="row g-3" action="{{route('productOfPeople.update',$product->id)}}" method="post"  enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="inputName5" name="productCode" placeholder="Enter the Product name" value="{{$product->productCode}}">
                                </div>
                                <div class="col-md-12">
