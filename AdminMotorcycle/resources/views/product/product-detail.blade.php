        ...
        <div class="container-product p-5 mt-5">
            <div class="container-row">
                <div class="product-image">
                    <div id="produto">
                        <img class="demo" src="images/products/{{ $product->image }}" alt="">
                    </div>
                    <ul id="haha">
                        @foreach ($product->thumbnails as $thumb)
                            <li>
                                <img src="images/chillImageProducts/{{ $thumb->thumb_image }}" alt="">
                            </li>
                        @endforeach
                    </ul>
                    <div class="img-ads">
                ...
                <div class="brand">
                    <ul class="top-brand">
                        <li>@lang('main.categories') <a href="">{{ $product->category->categoryName }}</a></li>
                    </ul>
                                ...
                                <div class="images">
                                    @foreach ($productOrderSame as $same)
                                        <a href="{{ route('product.show', $same->pro_id) }}">
                                            <img src="images/products/{{ $same->image }}" alt="">
                                        </a>
                                    @endforeach
                                </div>
                            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-12">
                <h2>@lang('main.product.description')</h2>
                <div class="container-product">
